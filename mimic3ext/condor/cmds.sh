...
python -um mimic3ext.learn -input_dir data -output_dir ../../outputs -epochs 2 |& tee ../../train_test.log
best_state=$(python -um mimic3ext.identify_state -states_dir ../../outputs/keras_states/ -mode best -epochs 2)
